import {
    ...
    CREATE_INVOICE_ORDER_SERVICE_ROUTE,
    CREATE_SERVICES_ROUTE,
    CREATE_TICKETS_ROUTE,
    DOMAINS_ROUTE,
    HOME_ROUTE,
    INDEX_CUSTOMER_DOMAIN_ROUTE,
    INDEX_CUSTOMER_HOSTING_ROUTE,
    INDEX_CUSTOMER_PROFILE_ROUTE,
    INDEX_CUSTOMER_SERVICES_ROUTE,
    INDEX_DOMAIN_REG_ROUTE,
    INDEX_DOMAIN_ROUTE,
    INDEX_HOSTING_ROUTE,
    INDEX_INVOICES_ROUTE,
    INDEX_ORDERS_ROUTE,
...
export const authRoutes = [
    ...
    {
        path: SHOW_TICKETS_ROUTE  + '/:id',
        Component: TicketsShow
    },
    {
        path: INDEX_CUSTOMER_PROFILE_ROUTE,
