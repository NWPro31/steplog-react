...
import {
    DASHBOARD_ROUTE, INDEX_CUSTOMER_DOMAIN_ROUTE,
    INDEX_ORDERS_ROUTE,
...
const CustomerDomainShow = observer(() => {
    ...
    const hrefs = [
        ...
        { href: DASHBOARD_ROUTE + '/' + INDEX_CUSTOMER_DOMAIN_ROUTE, name: "Список доменов" },
    ...
    useEffect(()=>{
        showOrderDomain(id).then(data => {
            ...
            if(!data.order_domain.ns) setNs([{ns: '', ip: '', number: Date.now()}]);
        }).finally(()=>{
                            ...
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-12 col-md-12 col-lg-9 order-2 order-md-1">
                                        <div className="row">
                                            ...
                                            <div className="col-12 col-lg-8 pt-3 pb-3">
                                                <span>
                                                    {domain.orderDomain.ns && domain.orderDomain.ns.map(item =>
                                                    <div key={item.number}>
                                                        {item.ns}
                                                    </div>
                                                    )}
                                            ...
                                            <div className="col-12 col-lg-8 pt-3 pb-3 bg-light">
                                                <span>
                                                    начиная с {timeToBefore(domain.orderDomain.reg_before)}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 col-md-12 col-lg-3 order-1 order-md-2">
                                        ...
                                        {invoiceToBefore(domain.orderDomain.reg_before) &&
                                            <button className="btn btn-info btn-sm m-1"
                                                    onClick={() => {
...
export default CustomerDomainShow;