...
import {
    ...
    INDEX_ORDERS_ROUTE,
    UPDATE_ORDERS_ROUTE, CREATE_INVOICE_ORDER_SERVICE_ROUTE, INDEX_CUSTOMER_SERVICES_ROUTE
} from "../../../../utils/consts";
...
const CustomerServicesShow = observer(() => {
...
export default CustomerServicesShow;