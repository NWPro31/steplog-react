                        ...
                        <Table striped>
                            ...
                            {invoice.invoice.length > 0 && invoice.invoice.map(item => (
                                <tr key={item.id}>
                                    ...
                                    ${item.status.id === 1 ? 'text-warning' : ''}
                                    ${item.status.id === 3 ? 'text-success' : ''}
                                    ${item.status.id === 2 ? 'text-info' : ''}
                                    ${item.status.id === 4 ? 'text-danger' : ''}`}>{item.status.title}</td>
                                    <td className="align-middle text-center project-actions">
                                        ...
                                        {item.status.id === 3 ? 'Банковский перевод' : ''}
                                    </td>
                                </tr>
                            ))}
                            </tbody>
