                            ...
                            {!loading && ticket.ticketMessages.length > 0  && ticket.ticketMessages.map(message => (
                                <div key={message.id} className={`direct-chat-msg ${message.user_role !== "admin" ? 'right' : ''}`}>
                                    ...
                                    <div className="ticket-img img-circle direct-chat-img">
                                        <img className="circle-img" style={{maxWidth: '40px', maxHeight: '40px'}} src={message.image_url ? `https://laravel.steplog.ru/thumbnail/${message.image_url}` : `/img/user2-160x160.jpg`}
